...
const AdminDashboard = () => {
    ...
    const styles = {
      ...
      header: {
        position: "fixed",
        top: 0,
        left: isSidebarOpen ? (isDesktopOrLaptop ? "250px" : "200px") : "80px",
        width: `calc(100% - ${isSidebarOpen ? (isDesktopOrLaptop ? "250px" : "200px") : "80px"})`,
        backgroundColor: "#2c3e50",
        color: "#ecf0f1",
        padding: "1rem 2rem",
        display: "flex",
      ...
      sidebar: {
        ...
        top: 0,
        left: 0,
        width: isSidebarOpen ? (isDesktopOrLaptop ? "250px" : "200px") : "80px",
        height: "100vh",
        backgroundColor: "#34495e",
        transition: "width 0.3s ease",
        zIndex: 99,
      ...
      content: {
        flex: 1,
        marginLeft: isSidebarOpen ? (isDesktopOrLaptop ? "250px" : "200px") : "80px",
        padding: "2rem",
        backgroundColor: "#f8f9fa",
        overflowY: "auto",
        transition: "margin-left 0.3s ease",
