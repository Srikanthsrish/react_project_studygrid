...
//   const links = [
//     { path: "/admin/dashboard/home", icon: <HomeIcon /> },
//     { path: "/admin/dashboard/students", icon: <StudentsIcon /> },
//     { path: "/admin/dashboard/teachers", icon: <TeachersIcon /> },
//     { path: "/admin/dashboard/subjects", icon: <SubjectsIcon /> },
//     { path: "/admin/dashboard/classes", icon: <ClassesIcon /> },
//     { path: "/admin/dashboard/notices", icon: <NoticesIcon /> },
//     { path: "/admin/dashboard/complains", icon: <ComplainsIcon /> },
//     { path: "/admin/dashboard/profile", icon: <ProfileIcon /> },
